...
The 3.0 release scope additionally includes the
[UI/UX modernization](3.0-ui-ux-modernization.md), a new product requirement
ratified after charter completion. It is tracked as release work rather than a
retroactive charter row; stabilization starts after its final merged slice.
