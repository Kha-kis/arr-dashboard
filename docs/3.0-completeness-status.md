...
| 2.1 — embedded rule composer | 🚧 | v1 read API + viewer (#553/#554); cleanup and auto-tag authoring (#562/#563); notifications authoring (#566); cross-domain rules/executor/deploy in progress. Deploy lifecycle ratified 2026-07-15 and recorded in ADR-0006. |
...
1. **Operator Console composer** (2.1) — PR-4 cross-domain rules/executor/dry-run/deploy, using the ratified draft → dry-run → atomic active-snapshot lifecycle.
