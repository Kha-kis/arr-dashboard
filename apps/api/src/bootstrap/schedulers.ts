...
import crossDomainSchedulerPlugin from "../plugins/cross-domain-scheduler.js";
...
export function registerSchedulers(app: FastifyInstance): void {
	...
	app.register(crossDomainSchedulerPlugin);
	...
	// Media server caches (Plex / Jellyfin / Emby / optional Tautulli)
