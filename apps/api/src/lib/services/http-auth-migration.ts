...
/**
 * Move legacy URL userinfo into encrypted service credentials. Older releases
 * accepted URLs such as https://user:pass@example.test even though Node fetch
 * refuses to construct requests from them.
 */
