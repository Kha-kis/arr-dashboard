...
export const LoginForm = () => {
  ...
  const redirectTarget = useMemo(() => sanitizeRedirect(searchParams?.get("redirectTo") ?? null), [searchParams]);
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await loginMutation.mutateAsync({ identifier: trimmedIdentifier, password });
      setPassword("");
