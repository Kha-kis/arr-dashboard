...
export const TemplateList = ({
	...
	return (
		<div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
			...
			<div className="flex flex-col gap-4 rounded-2xl border border-border/30 bg-muted/10 p-4 sm:flex-row sm:items-center sm:justify-between">
				{/* Search Input */}
				...
				<>
					...
					<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
						{templates.map((template, index) => (
							<article
								key={template.id}
								className="group relative flex flex-col overflow-hidden rounded-2xl border border-border/30 bg-muted/10 p-6 transition-all duration-300 hover:border-border hover:bg-card/50 hover:shadow-lg animate-in fade-in slide-in-from-bottom-2"
								style={{
