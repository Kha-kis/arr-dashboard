		...
		<div className="space-y-4">
			...
			<Card className="border-green-500/30 bg-green-500/5">
				<CardHeader>
					...
					<CardDescription>
						These custom formats were manually added from the catalog. You can adjust scores or
						remove them.
					</CardDescription>
				</CardHeader>
				<CardContent>
		...
		<div className="space-y-4">
			<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
				<h3 className="text-lg font-semibold text-foreground">
					<span className="flex flex-col sm:inline-flex sm:items-center sm:gap-2">
						<span>
							{isClonedProfile ? "Browse Instance Custom Formats" : "Browse All Custom Formats"}
						</span>
						<span className="text-sm font-normal text-muted-foreground">
							{isClonedProfile
			...
			>
				<CardHeader>
					<CardTitle className="text-base">
						{isClonedProfile
							? "Instance Custom Formats Catalog"
							: "Additional Custom Formats Catalog"}
					</CardTitle>
					<CardDescription>
						{isClonedProfile
									...
									<div className="flex items-start gap-3">
										...
										<div className="flex-1">
											...
											{cf.description && (
												<details className="mb-2 group" onClick={(e) => e.stopPropagation()}>
													<summary
														className={`cursor-pointer text-xs transition flex items-center gap-1 ${
															isClonedProfile
