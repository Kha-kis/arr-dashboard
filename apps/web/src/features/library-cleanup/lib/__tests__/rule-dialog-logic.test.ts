...
function makeState(overrides: Partial<BuildParamsState> = {}): BuildParamsState {
	return {
		...
		plexAddedAtDays: 90,
		jellyfinLastWatchedOp: "older_than",
		jellyfinLastWatchedDays: 90,
		jellyfinWatchCountOp: "less_than",
		jellyfinWatchCountVal: 1,
		jellyfinOnDeckVal: false,
		jellyfinUserRatingOp: "less_than",
		jellyfinUserRatingVal: 5,
		jellyfinWatchedByOp: "includes_any",
		selectedJellyfinUsers: ["jellyfinUser1"],
		jellyfinAddedAtOp: "older_than",
		jellyfinAddedAtDays: 90,
