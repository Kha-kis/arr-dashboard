...
export const SettingsClient = () => {
  ...
  const {
    ...
    editingSupportsDefaults
      ? (serviceFormState.selectedServiceForEdit?.id ?? null)
      : null,
    serviceFormState.selectedServiceForEdit?.service === "sonarr"
      ? "series"
      : "movie",
    editingSupportsDefaults,
  );
      ...
      {activeTab === "services" && (
        <div className="grid gap-6 xl:grid-cols-[2fr,1fr]">
          ...
          <ServiceForm
            ...
            onCancel={() =>
              serviceFormState.resetForm(serviceFormState.formState.service)
            }
            onTestConnection={() =>
