...
export const DashboardClient = () => {
  ...
  const handleQueueRetry = (items: QueueItem[]) =>
    queueActions.executeAsync("retry", items);
    ...
    <section className="flex flex-col gap-10">
      <header className="space-y-2">
        ...
        <p className="text-white/70">
          Here is a quick snapshot of the configured *arr instances. Use the
          refresh button to pull the latest configuration snapshot.
        </p>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <article className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur">
          ...
          <p className="mt-1 text-sm text-white/70">
            Items across Sonarr and Radarr queues.
          </p>
        </article>
      </div>
      ...
      <div className="space-y-3">
        ...
        {queueMessage && (
          <Alert
            variant="success"
            dismissible
            onDismiss={() => setQueueMessage(null)}
          >
