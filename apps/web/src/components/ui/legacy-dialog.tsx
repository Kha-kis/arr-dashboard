...
export function LegacyDialogHeader({
	...
	return (
		<div
			className={cn(
				"flex items-center justify-between gap-4 border-b border-border/30 p-6",
				className,
			)}
			style={{
...
export function LegacyDialogTitle({
	children,
	className,
	id,
}: {
	...
	return (
		<h2 id={titleId} className={cn("text-xl font-bold text-foreground", className)}>
			{children}
		</h2>
	);
}

export function LegacyDialogDescription({
	children,
	className,
}: {
	children: React.ReactNode;
...
export function LegacyDialogContent({
	children,
	className,
}: {
	children: React.ReactNode;
...
export function LegacyDialogFooter({
	children,
	className,
}: {
	children: React.ReactNode;
	...
	return (
		<div
			className={cn("flex items-center justify-end gap-3 border-t border-border/30 p-6", className)}
		>
			{children}
		</div>
	);
