 ...
 * ```
 */
export function Typography({ as, variant = "body", className, children }: TypographyProps) {
	const element = as || defaultElements[variant];

	return createElement(element, { className: cn(variantStyles[variant], className) }, children);
}
