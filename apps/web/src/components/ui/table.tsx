...
>(({ className, ...props }, ref) => (
	<thead
		ref={ref}
		className={cn("border-b border-border/50 bg-muted/30", "[&_tr]:border-b-0", className)}
		{...props}
	/>
));
...
>(({ className, ...props }, ref) => (
	<caption ref={ref} className={cn("py-4 text-sm text-muted-foreground", className)} {...props} />
));
