...
> **Version 3.0.0-beta.1** — Feature-complete preview of the 3.0 trust layer: Operator Console, unified automation composer, Tracearr analytics, and guided Setup. Use the immutable `3.0.0-beta.1` image or the moving `beta` channel. This preview does not replace `latest`; the full 3.0 documentation rewrite is still in progress.
...
| `beta` | Moving 3.0 beta preview channel; never promoted to `latest` automatically |
| `3.0.0-beta.1` | **Trust layer beta** — feature-complete Operator Console, unified automation composer, Tracearr integration, guided Setup rewrite, beta-readiness fixes, and dependency security remediation. See the changelog for upgrade and preview details. |
